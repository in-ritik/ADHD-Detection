"""
Trains the optimal Logistic Regression model using the Top 75 features identified in tuning.
"""
...
# Optimal feature set from tuning
...
def load_and_merge_data(feature_list):
    """
    Loads, filters, and merges the datasets on ID.
    """
    print("--- Loading Data ---")
...
def train_final_model(X, y):
    """
    Trains the final pipeline (Imputer -> Scaler -> LogReg).
    """
    print("\n--- Training Model ---")
    ...
    param_grid = {'classifier__C': [0.01, 0.1, 0.5, 1.0, 10.0]}
